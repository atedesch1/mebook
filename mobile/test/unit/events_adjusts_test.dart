...
void main() {
  test('Should adjust the event time when the end is before the start', () {
    ...
    final timeagg_0 = TimeAggregate(
        extractDate(start_date_0),
        extractTimeOfDay(start_date_0),
        extractDate(end_date_0),
        extractTimeOfDay(end_date_0));
    ...
    final timeagg_1 = TimeAggregate(
        extractDate(start_date_1),
        extractTimeOfDay(start_date_1),
        extractDate(end_date_1),
        extractTimeOfDay(end_date_1));
    ...
    final timeagg_2 = TimeAggregate(
        extractDate(start_date_2),
        extractTimeOfDay(start_date_2),
        extractDate(end_date_2),
        extractTimeOfDay(end_date_2));
    ...
    final timeagg_3 = TimeAggregate(
        extractDate(start_date_3),
        extractTimeOfDay(start_date_3),
        extractDate(end_date_3),
        extractTimeOfDay(end_date_3));
    ...
    final timeagg_4 = TimeAggregate(
        extractDate(start_date_4),
        extractTimeOfDay(start_date_4),
        extractDate(end_date_4),
        extractTimeOfDay(end_date_4));
    ...
    final timeagg_5 = TimeAggregate(
        extractDate(start_date_5),
        extractTimeOfDay(start_date_5),
        extractDate(end_date_5),
        extractTimeOfDay(end_date_5));
